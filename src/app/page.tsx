  ...
  return(
    <div className="bg-[#252B42] min-h-screen">
     ...
     <div className="text-ceter mt-16 flex flex-col text-center mr-5 justify-center">
        <div><h1 className="text-white text-5xl font-bold mb-5">Selling on the</h1><br/></div>
        <div><h1 className="text-white text-6xl leading-10 tracking-normal font-bold mb-5">internet like a pro</h1><br/></div>
